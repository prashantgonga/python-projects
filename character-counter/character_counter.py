# Simple code which woulc count the number of times an individual characters 
# have been used in the book Romeo and Juliet by Shakespeare

import pprint

# ''' is used to escape a bunch of text
...
formattedText = pprint.pformat(count) #pprint is used to print the output in a nice format
print(formattedText)
